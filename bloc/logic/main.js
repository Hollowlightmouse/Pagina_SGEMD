...
const miembros = [
  ...
  { nombre: "Joel Sebastián Bueno Medina", apodo: "frontend-dev", descripcion: "Diseñador y desarrollador frontend responsable de la interfaz web.", imagen: "bloc/style/img/Joel_Malo.jpg" },
  { nombre: "Johan Steven López Ordoñez", apodo: "backend-dev", descripcion: "Desarrollador backend enfocado en la lógica del sistema y gestión de base de datos.", imagen: "bloc/style/img/Johan_Sanchez.jpg" },
